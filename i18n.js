...
const I18n = (() => {
    ...
    const MESSAGES = {
        ja: {
            ...
            'stats_monthly': '月別',
            'filter_label': '判定機能:',
            'filter_block_label': 'ブロック機能:',
            'filter_all': 'ON + OFF合計',
            'filter_on': 'ONの時のみ',
            'filter_off': 'OFFの時のみ',
            'y_axis_auto': '軸: 自動',
            'y_axis_fixed': '軸: 24h固定',
            'patience_title': '💪 我慢回数',
            ...
            'timer_confirmation_time': '⏰ {time} に実行',
            'timer_cancelled': 'タイマーを解除しました',
            'timer_fired': 'タイマーにより{feature}を{action}しました',
            'timer_feature_check': '判定',
            'timer_feature_block': 'ブロック',
            'timer_feature_both': '両方',
            'timer_feature_action': '{features}を{action}にする',
            'timer_features_and': '{feature1}・{feature2}',
        ...
        en: {
            ...
            'filter_block_label': 'Block feature:',
            'filter_all': 'ON + OFF Total',
            'filter_on': 'When ON only',
            'filter_off': 'When OFF only',
            'y_axis_auto': 'Axis: Auto',
            'y_axis_fixed': 'Axis: 24h Fixed',
            ...
            'timer_confirmation_time': '⏰ Scheduled at {time}',
            ...
            'timer_feature_action': 'Turn {features} {action}',
            'timer_features_and': '{feature1} and {feature2}',
            'timer_action_on_past': 'ON',
            'timer_action_off_past': 'OFF',
            'timer_minutes': ' min',
            'timer_custom': 'Custom',
